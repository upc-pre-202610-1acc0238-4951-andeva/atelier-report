...
2. **Almacenamiento Local Robusto (Caché Offline-First):** Uso de bases de datos locales (ej. SQLite / Room / Hive / Isar) para mantener catálogos, historial de reparaciones y tareas en caché. La UI debe leer siempre de esta caché y no depender de llamadas directas a red, garantizando funcionamiento ininterrumpido en zonas de baja cobertura.
